...
public class CropOverlayView extends View {
     ...
     */
    private com.cropper.CropImageView.Guidelines mGuidelines;

    /**
     * The shape of the cropping area - rectangle/circular.
     */
    private com.cropper.CropImageView.CropShape mCropShape;
    ...
    public void resetCropOverlayView() {
        if (initializedCropWindow) {
            setCropWindowRect(com.cropper.BitmapUtils.EMPTY_RECT_F);
            initCropWindow();
            invalidate();
        }
    }
     ...
     * The shape of the cropping area - rectangle/circular.
     */
    public com.cropper.CropImageView.CropShape getCropShape() {
        return mCropShape;
    }
     ...
     * The shape of the cropping area - rectangle/circular.
     */
    public void setCropShape(com.cropper.CropImageView.CropShape cropShape) {
        if (mCropShape != cropShape) {
            mCropShape = cropShape;
            if (Build.VERSION.SDK_INT >= 11 && Build.VERSION.SDK_INT <= 17) {
                if (mCropShape == com.cropper.CropImageView.CropShape.OVAL) {
     ...
     */
    public com.cropper.CropImageView.Guidelines getGuidelines() {
        return mGuidelines;
    }
     ...
     */
    public void setGuidelines(com.cropper.CropImageView.Guidelines guidelines) {
    ...
    public void setInitialCropWindowRect(Rect rect) {
        mInitialCropWindowRect.set(rect != null ? rect : com.cropper.BitmapUtils.EMPTY_RECT);
        if (initializedCropWindow) {
            initCropWindow();
            invalidate();
     ...
     */
    public void setInitialAttributeValues(com.cropper.CropImageOptions options) {
    ...
    private void initCropWindow() {
        ...
        float leftLimit = Math.max(com.cropper.BitmapUtils.getRectLeft(mBoundsPoints), 0);
        float topLimit = Math.max(com.cropper.BitmapUtils.getRectTop(mBoundsPoints), 0);
        float rightLimit = Math.min(com.cropper.BitmapUtils.getRectRight(mBoundsPoints), getWidth());
        float bottomLimit = Math.min(com.cropper.BitmapUtils.getRectBottom(mBoundsPoints), getHeight());
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mCropWindowHandler.showGuidelines()) {
            ...
            if (mGuidelines == com.cropper.CropImageView.Guidelines.ON) {
                drawGuidelines(canvas);
            } else if (mGuidelines == com.cropper.CropImageView.Guidelines.ON_TOUCH && mMoveHandler != null) {
    ...
    private void drawBackground(Canvas canvas) {
        ...
        float left = Math.max(com.cropper.BitmapUtils.getRectLeft(mBoundsPoints), 0);
        float top = Math.max(com.cropper.BitmapUtils.getRectTop(mBoundsPoints), 0);
        float right = Math.min(com.cropper.BitmapUtils.getRectRight(mBoundsPoints), getWidth());
        float bottom = Math.min(com.cropper.BitmapUtils.getRectBottom(mBoundsPoints), getHeight());

        if (mCropShape == com.cropper.CropImageView.CropShape.RECTANGLE) {
            ...
            mPath.reset();
            if (Build.VERSION.SDK_INT >= 11 && Build.VERSION.SDK_INT <= 17 && mCropShape == com.cropper.CropImageView.CropShape.OVAL) {
    ...
    private boolean calculateBounds(RectF rect) {
        ...
        float left = com.cropper.BitmapUtils.getRectLeft(mBoundsPoints);
        float top = com.cropper.BitmapUtils.getRectTop(mBoundsPoints);
        float right = com.cropper.BitmapUtils.getRectRight(mBoundsPoints);
        float bottom = com.cropper.BitmapUtils.getRectBottom(mBoundsPoints);
