...
import com.cropper.*;
import com.cropper.BitmapCroppingWorkerTask;
import com.cropper.BitmapLoadingWorkerTask;
import com.cropper.BitmapUtils;
import com.cropper.CropImageAnimation;
import com.cropper.CropImageOptions;
...
public class CropImageView extends FrameLayout {
    ...
    public Rect getCropRect() {
        if (mBitmap != null) {
            ...
            return com.cropper.BitmapUtils.getRectFromPoints(points, orgWidth, orgHeight,
    ...
    public Bitmap getCroppedImage(int reqWidth, int reqHeight, RequestSizeOptions options) {
        ...
        if (mBitmap != null) {
            ...
            if (mLoadedImageUri != null && (mLoadedSampleSize > 1 || options == RequestSizeOptions.SAMPLING)) {
                int orgWidth = mBitmap.getWidth() * mLoadedSampleSize;
                int orgHeight = mBitmap.getHeight() * mLoadedSampleSize;
                com.cropper.BitmapUtils.BitmapSampled bitmapSampled =
                        com.cropper.BitmapUtils.cropBitmap(getContext(), mLoadedImageUri, getCropPoints(),
                                mDegreesRotated, orgWidth, orgHeight,
                                mCropOverlayView.isFixAspectRatio(), mCropOverlayView.getAspectRatioX(), mCropOverlayView.getAspectRatioY(),
                                reqWidth, reqHeight);
                croppedBitmap = bitmapSampled.bitmap;
            } else {
                croppedBitmap = com.cropper.BitmapUtils.cropBitmap(mBitmap, getCropPoints(), mDegreesRotated,
                        mCropOverlayView.isFixAspectRatio(), mCropOverlayView.getAspectRatioX(), mCropOverlayView.getAspectRatioY());
            }

            croppedBitmap = com.cropper.BitmapUtils.resizeBitmap(croppedBitmap, reqWidth, reqHeight, options);
        }
    ...
    public void setImageBitmap(Bitmap bitmap, ExifInterface exif) {
        ...
        if (bitmap != null && exif != null) {
            com.cropper.BitmapUtils.RotateBitmapResult result = com.cropper.BitmapUtils.rotateBitmapByExif(bitmap, exif);
    ...
    public void setImageUriAsync(Uri uri) {
        if (uri != null) {
            com.cropper.BitmapLoadingWorkerTask currentTask = mBitmapLoadingWorkerTask != null ? mBitmapLoadingWorkerTask.get() : null;
            if (currentTask != null) {
            ...
            clearImageInt();
            mCropOverlayView.setInitialCropWindowRect(null);
            mBitmapLoadingWorkerTask = new WeakReference<>(new com.cropper.BitmapLoadingWorkerTask(this, uri));
    ...
    public void rotateImage(int degrees) {
        if (mBitmap != null) {
            ...
            com.cropper.BitmapUtils.RECT.set(mCropOverlayView.getCropWindowRect());
            float halfWidth = (flipAxes ? com.cropper.BitmapUtils.RECT.height() : com.cropper.BitmapUtils.RECT.width()) / 2f;
            float halfHeight = (flipAxes ? com.cropper.BitmapUtils.RECT.width() : com.cropper.BitmapUtils.RECT.height()) / 2f;

            mImageMatrix.invert(mImageInverseMatrix);

            com.cropper.BitmapUtils.POINTS[0] = com.cropper.BitmapUtils.RECT.centerX();
            com.cropper.BitmapUtils.POINTS[1] = com.cropper.BitmapUtils.RECT.centerY();
            com.cropper.BitmapUtils.POINTS[2] = 0;
            com.cropper.BitmapUtils.POINTS[3] = 0;
            com.cropper.BitmapUtils.POINTS[4] = 1;
            com.cropper.BitmapUtils.POINTS[5] = 0;
            mImageInverseMatrix.mapPoints(com.cropper.BitmapUtils.POINTS);
            ...
            mImageMatrix.mapPoints(com.cropper.BitmapUtils.POINTS2, com.cropper.BitmapUtils.POINTS);
            mZoom /= Math.sqrt(Math.pow(com.cropper.BitmapUtils.POINTS2[4] - com.cropper.BitmapUtils.POINTS2[2], 2) + Math.pow(com.cropper.BitmapUtils.POINTS2[5] - com.cropper.BitmapUtils.POINTS2[3], 2));
            ...
            double change = Math.sqrt(Math.pow(com.cropper.BitmapUtils.POINTS2[4] - com.cropper.BitmapUtils.POINTS2[2], 2) + Math.pow(com.cropper.BitmapUtils.POINTS2[5] - com.cropper.BitmapUtils.POINTS2[3], 2));
            halfWidth *= change;
            halfHeight *= change;

            // calculate the new crop window rectangle to center in the same location and have proper width/height
            com.cropper.BitmapUtils.RECT.set(com.cropper.BitmapUtils.POINTS2[0] - halfWidth, com.cropper.BitmapUtils.POINTS2[1] - halfHeight,
                    com.cropper.BitmapUtils.POINTS2[0] + halfWidth, com.cropper.BitmapUtils.POINTS2[1] + halfHeight);

            mCropOverlayView.resetCropOverlayView();
            mCropOverlayView.setCropWindowRect(com.cropper.BitmapUtils.RECT);
            applyImageMatrix(getWidth(), getHeight(), true, false);
            handleCropWindowChanged(false, false);
     ...
     */
    void onSetImageUriAsyncComplete(com.cropper.BitmapLoadingWorkerTask.Result result) {
    ...
    public void startCropWorkerTask(int reqWidth, int reqHeight, RequestSizeOptions options, Uri saveUri, Bitmap.CompressFormat saveCompressFormat, int saveCompressQuality) {
        if (mBitmap != null) {
            ...
            com.cropper.BitmapCroppingWorkerTask currentTask = mBitmapCroppingWorkerTask != null ? mBitmapCroppingWorkerTask.get() : null;
            if (currentTask != null) {
            ...
            int orgHeight = mBitmap.getHeight() * mLoadedSampleSize;
            if (mLoadedImageUri != null && (mLoadedSampleSize > 1 || options == RequestSizeOptions.SAMPLING)) {
                mBitmapCroppingWorkerTask = new WeakReference<>(new com.cropper.BitmapCroppingWorkerTask(this, mLoadedImageUri, getCropPoints(),
                        mDegreesRotated, orgWidth, orgHeight,
                        mCropOverlayView.isFixAspectRatio(), mCropOverlayView.getAspectRatioX(), mCropOverlayView.getAspectRatioY(),
                        reqWidth, reqHeight, options,
                        saveUri, saveCompressFormat, saveCompressQuality));
            } else {
                mBitmapCroppingWorkerTask = new WeakReference<>(new com.cropper.BitmapCroppingWorkerTask(this, mBitmap, getCropPoints(), mDegreesRotated,
                        mCropOverlayView.isFixAspectRatio(), mCropOverlayView.getAspectRatioX(), mCropOverlayView.getAspectRatioY(),
                        reqWidth, reqHeight, options,
                        saveUri, saveCompressFormat, saveCompressQuality));
            }
    ...
    public Parcelable onSaveInstanceState() {
        ...
        if (mLoadedImageUri != null && mBitmap != null) {
            ...
            com.cropper.BitmapUtils.mStateBitmap = new Pair<>(key, new WeakReference<>(mBitmap));
            bundle.putString("LOADED_IMAGE_STATE_BITMAP_KEY", key);
        }
        if (mBitmapLoadingWorkerTask != null) {
            com.cropper.BitmapLoadingWorkerTask task = mBitmapLoadingWorkerTask.get();
            if (task != null) {
        ...
        mImageMatrix.invert(mImageInverseMatrix);
        mImageInverseMatrix.mapRect(com.cropper.BitmapUtils.RECT);

        bundle.putParcelable("CROP_WINDOW_RECT", com.cropper.BitmapUtils.RECT);
        ...
        if (state instanceof Bundle) {
            ...
            if (mBitmapLoadingWorkerTask == null && mLoadedImageUri == null && mBitmap == null && mImageResource == 0) {
                ...
                if (uri != null) {
                    ...
                    if (key != null) {
                        Bitmap stateBitmap = com.cropper.BitmapUtils.mStateBitmap != null && com.cropper.BitmapUtils.mStateBitmap.first.equals(key)
                                ? com.cropper.BitmapUtils.mStateBitmap.second.get() : null;
                        if (stateBitmap != null && !stateBitmap.isRecycled()) {
                            com.cropper.BitmapUtils.mStateBitmap = null;
                ...
                if (newZoom > 0 && newZoom != mZoom) {
                    if (animate) {
                        if (mAnimation == null) {
                            ...
                            mAnimation = new com.cropper.CropImageAnimation(mImageView, mCropOverlayView);
                        }
    ...
    private void applyImageMatrix(float width, float height, boolean center, boolean animate) {
        if (mBitmap != null && width > 0 && height > 0) {
            ...
            if (mDegreesRotated > 0) {
                mImageMatrix.postRotate(mDegreesRotated, com.cropper.BitmapUtils.getRectCenterX(mImagePoints), com.cropper.BitmapUtils.getRectCenterY(mImagePoints));
                mapImagePointsByImageMatrix();
            }

            // scale the image to the image view, image rect transformed to know new width/height
            float scale = Math.min(width / com.cropper.BitmapUtils.getRectWidth(mImagePoints), height / com.cropper.BitmapUtils.getRectHeight(mImagePoints));
            if (mScaleType == ScaleType.FIT_CENTER || (mScaleType == ScaleType.CENTER_INSIDE && scale < 1) || (scale > 1 && mAutoZoomEnabled)) {
                mImageMatrix.postScale(scale, scale, com.cropper.BitmapUtils.getRectCenterX(mImagePoints), com.cropper.BitmapUtils.getRectCenterY(mImagePoints));
                mapImagePointsByImageMatrix();
            }

            // scale by the current zoom level
            mImageMatrix.postScale(mZoom, mZoom, com.cropper.BitmapUtils.getRectCenterX(mImagePoints), com.cropper.BitmapUtils.getRectCenterY(mImagePoints));
            mapImagePointsByImageMatrix();
            ...
            if (center) {
                ...
                mZoomOffsetX = width > com.cropper.BitmapUtils.getRectWidth(mImagePoints) ? 0
                        : Math.max(Math.min(width / 2 - cropRect.centerX(), -com.cropper.BitmapUtils.getRectLeft(mImagePoints)), getWidth() - com.cropper.BitmapUtils.getRectRight(mImagePoints)) / mZoom;
                mZoomOffsetY = height > com.cropper.BitmapUtils.getRectHeight(mImagePoints) ? 0
                        : Math.max(Math.min(height / 2 - cropRect.centerY(), -com.cropper.BitmapUtils.getRectTop(mImagePoints)), getHeight() - com.cropper.BitmapUtils.getRectBottom(mImagePoints)) / mZoom;
            } else {
    ...
    private void updateImageBounds(boolean clear) {
        if (mBitmap != null && !clear) {
            ...
            float scaleFactorWidth = mBitmap.getWidth() * mLoadedSampleSize / com.cropper.BitmapUtils.getRectWidth(mImagePoints);
            float scaleFactorHeight = mBitmap.getHeight() * mLoadedSampleSize / com.cropper.BitmapUtils.getRectHeight(mImagePoints);
