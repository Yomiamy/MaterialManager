...
import static com.picasso.Picasso.LoadedFrom;
...
public interface Target {
   ...
   * specified via {@link com.picasso.RequestCreator#error(android.graphics.drawable.Drawable)}
   * or {@link com.picasso.RequestCreator#error(int)}.
   */
   ...
   * <p>
   * <strong>Note:</strong> The passed {@link android.graphics.drawable.Drawable} may be {@code null} if none has been
   * specified via {@link com.picasso.RequestCreator#placeholder(android.graphics.drawable.Drawable)}
   * or {@link com.picasso.RequestCreator#placeholder(int)}.
   */
