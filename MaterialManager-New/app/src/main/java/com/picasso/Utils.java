...
import com.picasso.OkHttpDownloader;
...
import static com.picasso.Picasso.TAG;
...
final class Utils {
  ...
  */
  ...
  static void log(String owner, String verb, String logId, String extras) {
    Log.d(Picasso.TAG, format("%1$-11s %2$-12s %3$s %4$s", owner, verb, logId, extras));
  }
  ...
  static String createKey(Request data, StringBuilder builder) {
    ...
    if (data.hasSize()) {
      ...
      if (data.hasClipSize()) {
          builder.append("clip:").append(data.clipWidth).append('x').append(data.clipWidth);
          builder.append('\n');
      }
