...
/**
 * {@link com.picasso.RequestHandler} allows you to extend Picasso to load images
 * in ways that are not supported by default in the library.
 * <p>
 * <h2>Usage</h2>
 * <p>{@link com.picasso.RequestHandler} must be subclassed to be used. You will have to
 * override two methods ({@link #canHandleRequest(Request)} and
 * {@link #load(Request)}) with your custom logic to load images.</p>
 *
 * <p>You should then register your {@link com.picasso.RequestHandler} using
 * {@link com.picasso.Picasso.Builder#addRequestHandler(com.picasso.RequestHandler)}</p>
 *
 * <b>NOTE:</b> This is a beta feature. The API is subject to change in a backwards
 * incompatible way at any time.
 *
 * @see com.picasso.Picasso.Builder#addRequestHandler(com.picasso.RequestHandler)
 */
public abstract class RequestHandler {
  /**
   * {@link com.picasso.RequestHandler.Result} represents the result of a {@link #load(Request)} call in a
   * {@link com.picasso.RequestHandler}.
   *
   * @see com.picasso.RequestHandler
   * @see #load(Request)
   */
  public static final class Result {
    ...
    /**
     * Returns the resulting {@link com.picasso.Picasso.LoadedFrom} generated
     * from a {@link #load(Request)} call.
     */
  ...
  /**
   * Whether or not this {@link com.picasso.RequestHandler} can handle a request with the
   * given {@link Request}.
   */
   ...
   * @return A {@link com.picasso.RequestHandler.Result} instance representing the result.
   */
