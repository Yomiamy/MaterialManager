...
import static com.picasso.Picasso.Priority.LOW;
import static com.picasso.Utils.OWNER_HUNTER;
import static com.picasso.Utils.VERB_DECODED;
import static com.picasso.Utils.VERB_EXECUTING;
import static com.picasso.Utils.VERB_JOINED;
import static com.picasso.Utils.VERB_REMOVED;
import static com.picasso.Utils.VERB_TRANSFORMED;
import static com.picasso.Utils.getLogIdsForHunter;
...
class BitmapHunter implements Runnable {
  ...
  Bitmap hunt() throws IOException {
    ...
    if (bitmap != null) {
        if(data.hasClipSize()) {
            if((data.clipStartX + data.clipWidth <= bitmap.getWidth()) && (data.clipStartY + data.clipWidth <= bitmap.getHeight())) {
                try {
                    Bitmap newResult = Bitmap.createBitmap(bitmap, data.clipStartX, data.clipStartY, data.clipWidth, data.clipWidth, null, false);
                    if (newResult != bitmap) {
                        bitmap.recycle();
                        bitmap = newResult;
                    }
