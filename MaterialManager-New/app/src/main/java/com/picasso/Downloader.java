...
public interface Downloader {
   ...
   * disk cache.
   * @return {@link com.livebricks.liveplates.util.picasso.Downloader.Response} containing either a {@link android.graphics.Bitmap} representation of the request or an
  ...
  /**
   * Allows to perform a clean up for this {@link com.picasso.Downloader} including closing the disk cache and
   * other resources.
   */
  void shutdown();
  ...
  class Response {
     ...
     * @deprecated Use {@link com.livebricks.liveplates.util.picasso.Downloader.Response#Response(java.io.InputStream, boolean, long)} instead.
     */
