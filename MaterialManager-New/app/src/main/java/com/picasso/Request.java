...
public final class Request {
  ...
  public final String stableKey;
    ...
    /**
     * Target clip start X point for clip.
     */
    public final int clipStartX;
    /**
     * Target clip start Y point for clip.
     */
    public final int clipStartY;
    /**
     * Target clip width for clip.
     */
  ...
  private Request(Uri uri, int resourceId, String stableKey, List<Transformation> transformations,
      int clipStartX, int clipStartY, int clipWidth, int targetWidth, int targetHeight, boolean centerCrop, boolean centerInside,
      float rotationDegrees, float rotationPivotX, float rotationPivotY, boolean hasRotationPivot,
      Bitmap.Config config, Picasso.Priority priority) {
    this.uri = uri;
  ...
  /** Builder for creating {@link com.picasso.Request} instances. */
  public static final class Builder {
    ...
    public Builder resize(int targetWidth, int targetHeight) {
      ...
      /**
       * Clip the image to the specified size in pixels.
       */
      public Builder clip(int startX, int startY, int width) {
          if (startX < 0) {
              throw new IllegalArgumentException("Width must be positive number or 0.");
          }
          if (startY < 0) {
          ...
          this.clipStartX = startX;
          this.clipStartY = startY;
    ...
    /** Create the immutable {@link com.picasso.Request} object. */
    public Request build() {
      ...
      return new Request(uri, resourceId, stableKey, transformations, clipStartX, clipStartY, clipWidth, targetWidth, targetHeight,
