...
public class CustomViewAbove extends ViewGroup {
	...
	private SlidingMenu.OnScrollListener mScrollListener;
	...
	/**
	 * Simple implementation of the {@link com.material.management.component.slidemenu.CustomViewAbove.OnPageChangeListener} interface with stub
	 * implementations of each method. Extend this if you do not intend to override
	 * every method of {@link com.material.management.component.slidemenu.CustomViewAbove.OnPageChangeListener}.
	 */
	 ...
	 * scrolled. See {@link com.material.management.component.slidemenu.CustomViewAbove.OnPageChangeListener}.
	 *
	...
	public void setOnScrollListener(SlidingMenu.OnScrollListener l) {
		mScrollListener = l;
	}
	...
	private boolean thisTouchAllowed(MotionEvent ev) {
		...
		if (isMenuOpen()) {
			View content = mViewBehind.getContent();
			if (content != null) {
